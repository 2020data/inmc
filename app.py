...
<div style="color: #444444; font-size: 16px; font-weight: 600; font-family: 'Times New Roman', serif; margin-top: 8px; margin-bottom: 5px; max-width: 90%; word-break: break-word; line-height: 1.3; font-style: italic;">
    {cat_name_value}
</div>
</div>
